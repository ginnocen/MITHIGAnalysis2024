...
void DzeroUPCTreeMessenger::CopyNonTrack(DzeroUPCTreeMessenger &M)
{
   ...
   if(Dtrk1Idx != nullptr && M.Dtrk1Idx != nullptr)   *Dtrk1Idx = *(M.Dtrk1Idx);
   ...
   if(Dtrk2Idx != nullptr && M.Dtrk2Idx != nullptr)   *Dtrk2Idx = *(M.Dtrk2Idx);
