...
const char* basic3(){return "JetPT > 70 && muPt1 > 4 && muPt2 > 4 && leadingjet_PTHat < 2.85 && muDiDxy1 > 0.01 && muDiDxy2 > 0.01 && TotalWeight < 2";}
//const char* basic3(){return "JetPT > 70 && muPt1 > 4 && muPt2 > 4 && leadingjet_PTHat < 2.85 && muDiDxy1 > 0.01 && muDiDxy2 > 0.01 && TotalWeight < 2 && (mumuMass > 3.2 || mumuMass < 2.9)";}

const char* data1(){return "JetPT > 70 && muPt1 > 4 && muPt2 > 4 && muDiDxy1 > 0.01 && muDiDxy2 > 0.01 ";}
