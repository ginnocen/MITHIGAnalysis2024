...
void QA(){
    ...
    QA_plots("DCAtot.root","DCAtot","totaldca","DCA_{tot}",15,-2.5,1,1,0,1.3);
    QA_plots("z.root","z","mumuz","z_{#mu#mu}",15,0,1,0,0,1.3);
    QA_plots("angularity_11.root","angularity_11","mumuang11","#lambda_{1}^{1}",15,-4,1,1,0,1.3);
    QA_plots("angularity_12.root","angularity_12","mumuang12","#lambda_{2}^{1}",15,-4,1,1,0,1.3);
    QA_plots("angularity_112.root","angularity_112","mumuang112","#lambda_{0.5}^{1}",15,-4,1,1,0,1.3);
