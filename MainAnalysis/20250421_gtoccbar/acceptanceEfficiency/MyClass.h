...
// Tue Feb 11 00:07:45 2025 by ROOT version 6.34.02
// from TTree Tree/Tree for MuMu tagged jet analysis (V8)
// found on file: root://eoscms.cern.ch//eos/cms/store/group/phys_heavyions/cbaldene/g2ccbar/mc2018/mergedfile_02102025.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data00/g2ccbar/mc2018/skimTest/mergedfile_02132025.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data00/g2ccbar/mc2018/skimTest/mergedfile_02132025.root");
      }
