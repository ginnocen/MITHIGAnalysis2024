...
if [ "$SAMPLEID" -eq 7 ]; then
    NAMEData="/data00/g2ccbar/data2018/skim_09232025_DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8_7/"
    FOLDER="/data00/g2ccbar/data2018/minBiasForest_02022025/mb7" 
fi
