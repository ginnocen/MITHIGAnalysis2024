...
for SAMPLEGEN_DIR in ${SAMPLEGEN_DIRS[@]}; do
  ...
  xrdcp -r -f include       	root://xrootd.cmsaf.mit.edu//store/user/$USER/MITHIGAnalysis2024/SampleGeneration/$SAMPLEGEN_DIR/
  xrdcp -f ReduceForest.cpp 	root://xrootd.cmsaf.mit.edu//store/user/$USER/MITHIGAnalysis2024/SampleGeneration/$SAMPLEGEN_DIR/
  xrdcp -f makefile         	root://xrootd.cmsaf.mit.edu//store/user/$USER/MITHIGAnalysis2024/SampleGeneration/$SAMPLEGEN_DIR/
done
